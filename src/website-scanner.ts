...
export async function scanWebsite( 
  ...
  // 3. Kontrollerar interna och externa länkar 
  console.log("\n--- LÄNKAR ---"); 
  ...
  // 6. Kontrollerar formulärvalidering 
  console.log("\n--- VALIDERING ---"); 
  ...
  // 8. Kontrollerar CTA-knappar och länkar 
  console.log("\n--- CTA ---"); 
  ...
  // 11. Kontrollerar Google Business Profile 
